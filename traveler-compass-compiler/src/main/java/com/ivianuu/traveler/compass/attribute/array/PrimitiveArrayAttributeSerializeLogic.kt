...
abstract class PrimitiveArrayAttributeSerializeLogic : ArrayAttributeSerializeLogic() {
    ...
    override fun addAttributeSerializeLogic(
        ...
        createBundlePut(builder, attribute, baseElement, "put${capitalizedPrimitive}Array", accessor)
        return true
    }
    ...
    override fun addBundleAccessorLogic(
        ...
        createBundleGet(builder, attribute, baseElement,  "get${capitalizedPrimitive}Array", valueName)
        return true
    }
}
