...
interface CompassDetourPilot : CompassDetour<Any, Fragment, Fragment> {
    fun <Destination : Any, CurrentFragment : Fragment, NextFragment : Fragment>
            registerDetour(detour: CompassDetour<Destination, CurrentFragment, NextFragment>,
                           destinationClass: KClass<Destination>,
                           currentFragmentClass: KClass<CurrentFragment>,
                           nextFragmentClass: KClass<NextFragment>)

    companion object {
        fun create(): CompassDetourPilot = OpenDetourPilot()
    }
}

inline fun <reified Destination : Any, reified CurrentFragment : Fragment, reified NextFragment : Fragment>
        CompassDetourPilot.registerDetour(detour: CompassDetour<Destination, CurrentFragment, NextFragment>) {
